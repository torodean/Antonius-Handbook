...
\begin{align}
	...
	L_{\pm} &= L_x\pm i L_y = \hbar e^{\pm i \phi} \left(\pm \frac{\partial}{\partial \theta}+ i \cot(\theta)\frac{\partial}{\partial \phi}\right)
\end{align}
...
\begin{align}
	...
	L_{\pm} | \ell, m \rangle = \hbar \sqrt{(\ell \mp m)(\ell \pm m +1)} | \ell, m \rangle
\end{align}
