...
\end{defn}
\begin{theo}[Subring Theorem]{SubringTheorem}
...
\end{defn}
\begin{defn}[Injective \& Surjective]{Injective and Surjective}
...
\begin{defn}[Common divisor]{common divisor}
	...
	\end{enumerate}
\end{defn}
\begin{defn}[Isomorphism and Homomorphism]{1}
...
\begin{defn}[Ideal]{Ideals}
	...
	\end{enumerate}
\end{defn}
\begin{theo}[Ideal Theorem]{Ideal theorem}
...
\end{defn}
\begin{theo}[First Isomorphism Theorem]{1}
