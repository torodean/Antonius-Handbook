...
\vec{F}&=-\nabla \vec{U}
\end{align}
\textbf{Hooke's Law}\index{Hooke's Law} states that the force needed to extend or compress a spring by some distance is proportional to that distance.
\begin{align}
...
\end{align}
The root-mean square displacement is a good measure of the average response of the oscillator and is given by \textbf{parseval's theorem}\index{parseval's theorem}
\begin{align}
...
\end{align}
The time evolution of a system is given by \textbf{Hamilton's equations}\index{Hamilton's equations}
\begin{align}
