...
We can define the \textbf{Fourier transform}\index{Fourier transform} of $f(x)$ \cite{bib:PDE book} by
\begin{align}
...
\end{align}
The \textbf{Fourier transform} of a \textbf{Gaussian}\index{Gaussian} \cite{bib:PDE book} is given by
\begin{align}
